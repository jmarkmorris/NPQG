...
class standard_model_3d(ThreeDScene):
    def construct(self):
        ...
        text = Paragraph(
                    ...
                    '  Mapping : Standard model generation + Noether core binaries = 4. Assemblies flatten with velocity.\n'
                    ...
                    '  Mapping : Outer binary decay reveals mass-energy previously shielded by superposition.\n'
                    '  Mapping : Quark orbital plane orientations logically match Weinberg angle (~tau/12). (not shown)'
                    '  Note : Remaining charge distribution geometries for quarks and neutrinos seem counterintuitive.\n'
